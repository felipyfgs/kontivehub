# UI Archetypes Monitoring Lists

## Purpose

Definir o chrome canônico, os estados de carga e a estabilidade dos contratos
das listas fiscais compartilhadas por `MonitoringModuleTable`.
