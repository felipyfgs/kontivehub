# laravel-runtime-operations Specification

## Purpose

Definir operações de runtime canônicas da API Laravel: ports/adapters para
sistemas externos, egress HTTP bounded, políticas de jobs, saúde do Horizon,
coordenação de schedules, sanitização de logs/métricas, quarentena de retries e
evidência de qualidade nativa ao projeto.
