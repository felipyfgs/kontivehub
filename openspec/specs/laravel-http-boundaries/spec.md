# laravel-http-boundaries Specification

## Purpose

Definir os boundaries HTTP canônicos da API Laravel: validação e autorização na
borda, controllers apenas orquestradores, Resources estáveis, Policies
fail-closed, rate limits nomeados, proteção contra request forgery e envelopes
de erro tipados.
