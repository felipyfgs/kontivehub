# ui-archetypes-batch-roadmap Specification

## Purpose

Definir a sequência aprovável de lotes de padronização de arquétipos UI
(admin, monitoring, dashboards, master-detail, docs, quick wins), cada um
exigindo change OpenSpec próprio antes da implementação.
