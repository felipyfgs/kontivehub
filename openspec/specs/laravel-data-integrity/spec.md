# laravel-data-integrity Specification

## Purpose

Definir invariantes de integridade de dados na API Laravel: carregamento
explícito, processamento bounded de datasets grandes, migrations/factories
forward-safe, cache escopado, workflows multi-write atômicos e isolamento de
tenant fail-closed.
