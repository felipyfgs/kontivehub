# ui-archetypes-quick-wins Specification

## Purpose

Padronizações pontuais de chrome UI sem novo arquétipo: erro de carga inicial
via `ShellLoadError`, toolbar canônica de fechamento, cards de seção drop-in e
preservação de contratos/gates (incluindo dívida explícita de KPI strips).
