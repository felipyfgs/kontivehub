...
Alterar busca, filtro, ordenação, inbox ou tenant SHALL limpar a seleção. Carregar outra página SHALL preservar os IDs anteriores, mas SHALL NOT selecionar automaticamente as novas linhas.
...
- **WHEN** o usuário alterna o checkbox de uma linha
...
A lista SHALL virtualizar linhas carregadas e carregar páginas adicionais por sentinel, preservando fallback/retry, fim da lista, item ativo e scroll. Checkbox, abertura e menu SHALL ser controles semanticamente separados, operáveis por teclado e touch; nenhuma seleção SHALL depender exclusivamente de hover.
