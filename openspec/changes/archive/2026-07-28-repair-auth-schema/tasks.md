...
- [x] 1.1 Adicionar migration reversível para alinhar as tabelas anteriores de identidade
- [x] 1.2 Adicionar tradução pt-BR para falhas de autenticação do Fortify
- [x] 1.3 Cobrir migration de compatibilidade, login inválido localizado e fluxo Sanctum válido
...
- [x] 3.1 Aplicar a migration sem limpar os dados locais
- [x] 3.2 Validar CSRF, login válido, `/me` autenticado, erro inválido localizado,
...
- [x] 3.3 Executar os gates focados de API e web
