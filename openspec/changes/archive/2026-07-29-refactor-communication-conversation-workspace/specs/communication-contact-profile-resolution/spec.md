...
Merge PN↔LID SHALL escolher, por fonte e inbox, a observação mais recente. Export SHALL incluir os novos dados autorizados e purge SHALL removê-los.
...
#### Scenario: Avatar remoto permanece fora do escopo
- **WHEN** `picture_id` é observado
- **THEN** somente essa versão/invalidação é persistida, sem buscar nem salvar URL de avatar
