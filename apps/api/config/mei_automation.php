...
return [
    ...
    'tenant_allowlist' => $parseIdList(env('MEI_AUTOMATION_TENANT_ALLOWLIST')),
    'allow_all_tenants' => filter_var(env('MEI_AUTOMATION_ALLOW_ALL_TENANTS', false), FILTER_VALIDATE_BOOL),
