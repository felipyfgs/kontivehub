...
return new class extends Migration
{
    ...
    {
        Schema::create('pagtoweb_payment_list_observations', function (Blueprint $table) {
            ...
            $table->unique(['tenant_id', 'client_id', 'digest'], 'pagtoweb_payment_list_observations_tenant_id_clien_5a487d7bf3');
