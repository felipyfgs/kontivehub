...
final readonly class StartConversationAction
{
    public function __construct(
        private ContactCanonicalizer $contacts,
        private ConversationCanonicalizer $conversations,
        private OutboundConversationGate $gate,
    ...
    public function handle(int $contactId, int $identityId, int $inboxId, MessageCreationData $data): array
    {
        $stagedObjectId = null;
