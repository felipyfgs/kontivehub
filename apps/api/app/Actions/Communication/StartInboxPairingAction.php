...
final readonly class StartInboxPairingAction
{
    ...
    public function handle(CommunicationInbox $inbox): InboxPairingResult
    {
        ...
        return new InboxPairingResult($state);
    }
}
