...
use Database\Factories\TenantSerproOnboardingStateFactory;
...
class TenantSerproOnboardingState extends Model
{
    /** @use HasFactory<TenantSerproOnboardingStateFactory> */
    use BelongsToTenant;

    use HasFactory;

    protected static function newFactory(): TenantSerproOnboardingStateFactory
    {
        return TenantSerproOnboardingStateFactory::new();
    }
    ...
    protected function casts(): array
    {
        return [
            ...
            'status' => TenantSerproOnboardingStatus::class,
