...
#[Fillable([
    'tenant_id', 'tenant_fiscal_identity_id', 'interested_root_cnpj', 'query_cnpj',
...
class TenantDistributionCursor extends Model
{
    use BelongsToTenant;
    use HasFactory;
    ...
    {
        return $this->hasMany(TenantDistributionRun::class);
    }
