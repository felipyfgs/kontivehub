...
final readonly class CommunicationMessageProjectionMaintenance
{
    ...
    public function run(
        CommunicationMaintenanceContext $context,
    ...
    /** @return array<string,mixed> */
    private function reverse(CommunicationMaintenanceContext $context, string $operationId): array
    {
    ...
    private function assertTrustedScope(CommunicationMaintenanceContext $context): void
    {
    ...
    private function audit(CommunicationMaintenanceContext $context, string $action, array $result): void
    {
        $this->audit->record(
            action: $action,
