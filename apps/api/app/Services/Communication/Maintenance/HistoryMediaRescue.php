...
final readonly class HistoryMediaRescue
{
    /** @var list<string> */
    ...
    public function run(MaintenanceContext $context, int $requestedLimit): array
    {
    ...
    private function hasPendingResult(MaintenanceContext $context): bool
    {
    ...
    private function eligibleCandidates(MaintenanceContext $context, int $limit): Collection
    {
        $eligible = collect();
        $lastOccurredAt = null;
        $lastId = null;
    ...
    private function assertTrustedScope(MaintenanceContext $context): CommunicationInbox
    {
    ...
    private function audit(MaintenanceContext $context, array $result): void
    {
        $this->audit->record(
