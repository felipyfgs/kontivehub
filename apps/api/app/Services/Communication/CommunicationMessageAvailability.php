...
use App\DTO\Communication\CommunicationMessageAvailabilityData;
use App\Enums\Communication\MessageAvailabilityState;
use App\Enums\Communication\MessageKind;
use App\Models\CommunicationMessage;

final class CommunicationMessageAvailability
{
    /** @var list<string> */
    ...
    public function forMessage(CommunicationMessage $message): CommunicationMessageAvailabilityData
    {
    ...
    ): CommunicationMessageAvailabilityData {
        return new CommunicationMessageAvailabilityData($state, $recoverable);
    }
