...
final class ContactService
{
    public function __construct(
        ...
        private readonly ContactCanonicalizer $contactCanonicalizer,
        private readonly ConversationCanonicalizer $peerCanonicalizer,
    ) {}

    public function create(ContactCreationData $data): CommunicationContact
    {
        ...
        try {
            return DB::transaction(function () use ($tenant, $data, $address): CommunicationContact {
                ...
                if ($data->clientId !== null) {
                    $this->link($identity, new IdentityLinkData(
