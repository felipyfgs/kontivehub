...
final readonly class AutomationQuery
{
    ...
    public function index(): AutomationIndexData
    {
        return new AutomationIndexData(
    ...
    public function recipients(
        ...
        return new RecipientConfigurationData(
            client: $client,
