...
final class SerproOpsAlertService
{
    ...
    public function scan(): array
    {
        ...
        foreach ($lifecycle['alerts'] as $a) {
            ...
            $alerts[] = [
                ...
                'runbook' => $runbook,
                'scope' => ($a['tenant_id'] ?? null) !== null ? 'TENANT' : 'GLOBAL',
            ];
        ...
        try {
            ...
            // Falha de leitura não impede que os demais alertas sejam emitidos.
        }
    ...
    {
        return match ($kind) {
            'CONTRACTOR_PFX', 'AUTHOR_CERTIFICATE' => $this->runbook('cert_expiry'),
