...
final readonly class DepartmentService
{
    ...
    public function create(DepartmentData $data): WorkDepartment
    {
    ...
    public function assignMembership(
        WorkDepartment $department,
        DepartmentMembershipData $data,
    ): DepartmentAssignmentResult {
        return DB::transaction(function () use ($department, $data): DepartmentAssignmentResult {
            ...
            return new DepartmentAssignmentResult(
