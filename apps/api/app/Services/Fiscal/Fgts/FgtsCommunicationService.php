...
namespace App\Services\Fiscal\Fgts;
...
/** Comunicação FGTS — core compartilhado, submodule isolado. */
final class FgtsCommunicationService
{
    public const MODULE = 'fgts';

    public const SUBMODULE = 'fgts';
     ...
     */
    public function updatePreferences(Office $office, Client $client, User $actor, array $input): ClientCommunicationPreference
    {
