...
/** Comunicação SITFIS — core compartilhado, submodule isolado. */
final class SitfisCommunicationService
{
    public const MODULE = 'sitfis';

    public const SUBMODULE = 'sitfis';
