 ...
 * Reutiliza certificado/identidade do tenant; nunca ClientCredential.
 * Roteia por emit/CNPJ; exige presença do query_cnpj em autXML.
 */
final class TenantCteAutXmlPageProcessor
{
    ...
    private function persistPrincipal(
        ...
        // Interesses IN para outros clientes do mesmo tenant em papéis de interesse
    ...
    private function quarantine(
        ...
        FiscalDocumentQuarantine::query()->firstOrCreate(
            ...
            [
                ...
                'metadata' => ['tenant_distribution_cursor_id' => $cursor->id],
            ]
        );
    }
