...
use App\Jobs\SyncTenantCteAutXmlDistDfeJob;
use App\Models\TenantDistributionCursor;
use App\Support\CteAutXmlFeature;
use Illuminate\Console\Command;

class DispatchDueTenantCteAutXmlSyncsCommand extends Command
{
    ...
    public function handle(): int
    {
        ...
        $due = TenantDistributionCursor::query()
        ...
        foreach ($due as $cursor) {
            ...
            $delay = ($cursor->id % 60);
            SyncTenantCteAutXmlDistDfeJob::dispatch($cursor->id, 'SCHEDULED')
