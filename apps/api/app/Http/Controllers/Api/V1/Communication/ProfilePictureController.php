...
{
    public function show(ViewCommunicationProfilePictureRequest $request, CommunicationInboxIdentityProfile $profile, int $version, StreamProfilePictureAction $action): Response
    {
