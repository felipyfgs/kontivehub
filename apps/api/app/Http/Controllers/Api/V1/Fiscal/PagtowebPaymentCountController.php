...
{
    public function __construct(private readonly CurrentOffice $currentOffice, private readonly PagtowebPaymentCountQueryService $queries, private readonly TenantAuthorization $authorization) {}
