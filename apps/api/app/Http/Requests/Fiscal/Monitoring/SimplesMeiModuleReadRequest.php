...
abstract class SimplesMeiModuleReadRequest extends AuthenticatedRequest
{
    ...
    final protected function prepareForValidation(): void
    {
        ...
        $this->prepareSimplesMeiModuleValidation();
    }

    protected function prepareSimplesMeiModuleValidation(): void {}
