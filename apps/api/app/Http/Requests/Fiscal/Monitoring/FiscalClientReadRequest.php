...
abstract class FiscalClientReadRequest extends AuthenticatedRequest
{
    ...
    final protected function prepareForValidation(): void
    {
        ...
        $this->prepareFiscalClientValidation();
    }

    protected function prepareFiscalClientValidation(): void {}

    final public function clientId(): int
    {
        return (int) $this->route('client');
    }

    final public function ensureCanView(
        Client $client,
        string $message = 'Sem permissão para consultar o monitoramento fiscal.',
    ): void {
        $actor = $this->actor();
