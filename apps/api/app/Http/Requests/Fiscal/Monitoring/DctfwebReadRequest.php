...
abstract class DctfwebReadRequest extends AuthenticatedRequest
{
    ...
    final protected function prepareForValidation(): void
    {
        ...
        $this->prepareDctfwebValidation();
    }

    protected function prepareDctfwebValidation(): void {}

    protected function failedAuthorization(): void
    {
        throw new AuthorizationException('Perfil não resolvido.');
    }
