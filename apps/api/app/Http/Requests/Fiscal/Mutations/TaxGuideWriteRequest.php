...
abstract class TaxGuideWriteRequest extends AuthenticatedRequest
{
    public function authorize(): bool
    {
        ...
        return $actor instanceof User
            && app(TenantAuthorization::class)->allows(
                $actor,
                TenantPermission::FiscalMutationsExecute,
            );
    }
    ...
    final protected function prepareForValidation(): void
    {
        ...
        $this->prepareTaxGuideWriteValidation();
    }

    protected function prepareTaxGuideWriteValidation(): void {}

    protected function failedAuthorization(): void
    {
        throw new AuthorizationException('Sem permissão para operações de guias.');
    }
}
