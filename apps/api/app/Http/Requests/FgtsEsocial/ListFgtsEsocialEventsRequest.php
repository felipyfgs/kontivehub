...
final class ListFgtsEsocialEventsRequest extends ViewFgtsEsocialRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'event_code' => ['sometimes', 'nullable', 'string', 'max:20'],
        ];
    }

    public function filters(): FgtsEsocialEventFilters
    {
        $validated = $this->validated();

        return new FgtsEsocialEventFilters(
