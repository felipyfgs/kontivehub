...
final class CommunicationOutboundInitiationConcurrencyTest extends TestCase
{
    ...
    public function test_same_idempotency_key_converges_to_one_conversation_message_and_outbox(): void
    {
        ...
        $workerEnvironment = [
            ...
            'COMMUNICATION_MEDIA_DISK_ROOT' => (string) config('filesystems.disks.communication_media.root'),
...
config([
    ...
    'filesystems.disks.communication_media.root' => getenv('COMMUNICATION_MEDIA_DISK_ROOT') ?: sys_get_temp_dir().'/kontivehub-tests-worker',
    'communication.media.disk_root' => getenv('COMMUNICATION_MEDIA_DISK_ROOT') ?: sys_get_temp_dir().'/kontivehub-tests-worker',
