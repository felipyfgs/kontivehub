...
final class IdentitySchemaCompatibilityMigrationTest extends TestCase
{
    /** @var list<string> */
    ...
    public function test_aligns_identity_fail_closed_and_rolls_back_only_added_columns(): void
    {
        $this->createIdentitySchema();
        $this->seedIdentityRows();
        $before = $this->schemaSnapshot(self::TABLES);
        ...
        self::assertFalse(Schema::hasTable('identity_schema_compatibility_columns'));
        ...
        self::assertSame($before, $this->schemaSnapshot(self::TABLES));
    }

    public function test_does_not_touch_current_tables_without_status(): void
    {
    ...
    public function test_backfills_only_memberships_with_fully_canonical_roles_and_profiles(): void
    {
        ...
        DB::table('tenant_memberships')->insert([
            ...
            ['id' => 7, 'tenant_id' => 1, 'user_id' => 7, 'role' => 'unknown_owner', 'status' => 'ACTIVE', 'permission_profile_id' => null],
    ...
    public function test_adds_and_removes_composite_permission_profile_integrity(): void
    {
        ...
        self::assertTrue(Schema::hasForeignKey(
            'tenant_memberships',
            'identity_schema_membership_permission_profile_fk',
        ));
        ...
        self::assertFalse(Schema::hasIndex(
            'tenant_permission_profiles',
            'identity_schema_permission_profiles_id_tenant_unique',
        ));
    }
    ...
    public function test_invalid_default_tenant_is_not_copied_before_foreign_key(): void
    {
    ...
    public function test_platform_settings_tolerates_missing_optional_source_columns(): void
    {
    ...
    private function seedIdentityRows(): void
    {
        ...
        DB::table('tenant_memberships')->insert([
            ...
            ['id' => 2, 'tenant_id' => 1, 'user_id' => 2, 'role' => 'unknown_owner', 'status' => 'ACTIVE'],
        ]);
        DB::table('platform_memberships')->insert([
            ['id' => 1, 'user_id' => 1, 'tenant_id' => 1, 'role' => 'platform_admin', 'status' => 'ACTIVE'],
            ['id' => 2, 'user_id' => 2, 'tenant_id' => 2, 'role' => 'unknown_admin', 'status' => 'ACTIVE'],
        ]);
        DB::table('platform_settings')->insert([
            'id' => 1,
            'name' => 'KontiveHub anterior',
            'status' => 'ACTIVE',
    ...
    private function migration(): Migration
    {
        return require database_path(
            'migrations/2026_07_28_020000_align_identity_schema_for_authentication.php',
        );
    }
