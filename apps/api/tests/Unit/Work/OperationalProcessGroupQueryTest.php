...
class OperationalProcessGroupQueryTest extends TestCase
{
    public function test_manual_constants_are_stable(): void
    {
        $this->assertSame('manual', OperationalProcessGroupQuery::MANUAL_KEY);
        $this->assertSame('Sem rotina', OperationalProcessGroupQuery::MANUAL_LABEL);
    }
    ...
    {
        $query = new OperationalProcessGroupQuery($this->createMock(CurrentOffice::class));
